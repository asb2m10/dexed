      ...
      cartManager(this)
{
    ...
    float targetScale = this->processor->is_clap ? processor->getDpiScaleFactor() : 1;
    setSize(WINDOW_SIZE_X * targetScale, ((processor->showKeyboard ? WINDOW_SIZE_Y : WINDOW_SIZE_Y - 94)) * targetScale);
    ...
    auto generalCallback = [this](ParamDialog *param)
                               {
                                   ...
                                   float targetScale = this->processor->is_clap ? scale : 1;
                                   this->setSize(WINDOW_SIZE_X * targetScale, ((processor->showKeyboard ? WINDOW_SIZE_Y : WINDOW_SIZE_Y - 94)) * targetScale);
